...
class Main {
  ...
  fun render() {
    ...
    val planet = Sprite(AssetsManager.peekMaterial("planet"), Vec2(-16384, 0), 160f, 0f, -26576f, isCulled = false)
    val moonNear = Sprite(AssetsManager.peekMaterial("moon-a"), Vec2(-8192, -2048), 48f, 0f, -14384f, isCulled = false)
    val moonFar = Sprite(AssetsManager.peekMaterial("moon-b"), Vec2(16384, 2048), 32f, 0f, -46000f, isCulled = false)
    val belt = Sprite(AssetsManager.peekMaterial("belt"), Vec2(-8192, -8192), 128f, 0f, -20000f, isCulled = false)
