...
class Main {
  ...
  fun render() {
    ...
    val planet = Sprite(AssetsManager.peekMaterial("planet"), Vec2(-16384, 0), 160f, 0f, -26576f, canBeCulled = false)
    val moonNear = Sprite(AssetsManager.peekMaterial("moon-a"), Vec2(-8192, -2048), 48f, 0f, -14384f, canBeCulled = false)
    val moonFar = Sprite(AssetsManager.peekMaterial("moon-b"), Vec2(16384, 2048), 32f, 0f, -46000f, canBeCulled = false)
    val belt = Sprite(AssetsManager.peekMaterial("belt"), Vec2(-8192, -8192), 128f, 0f, -20000f, canBeCulled = false)
    val pilot = Sprite(AssetsManager.peekMaterial("pilot-a"), Vec2.zero(), 1f, timePassed * .125f, 32f)
